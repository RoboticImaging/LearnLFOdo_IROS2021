...
class LFPoseNetViz(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_ref_imgs=2, encoder=None):
        ...
        """
        super(LFPoseNetViz, self).__init__()
    ...
    def forward(self, target_image, ref_imgs):
        ...
        self.out_conv1 = self.conv1(i_input)
        ...
        self.pose = self.pose_pred(self.out_conv7)
        self.pose = self.pose.mean(3).mean(2)
        self.pose = 0.01 * self.pose.view(self.pose.size(0), self.nb_ref_imgs, 6)      # TODO: What is 0.01 here?
